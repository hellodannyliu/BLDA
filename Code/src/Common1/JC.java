 ...
 *  i = 1 -> property.charAt[i] = 0 means input is not required; 1 required;
 *  i = 0 -> property.charAt[i] = 0 means Relative Path; 1 means absolute path
 *  
 *  Demo:
